...
import (
	...
	"github.com/deyuhua/delve/pkg/proc/linutil"
)
...
func ptraceGetRegset(tid int) (regset linutil.AMD64Xstate, err error) {
	...
	if err != syscall.Errno(0) {
		if err == syscall.ENODEV || err == syscall.EIO {
			// ignore ENODEV, it just means this CPU or kernel doesn't support XSTATE, see https://github.com/deyuhua/delve/issues/1022
