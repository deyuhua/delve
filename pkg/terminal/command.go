...
import (
	...
	"github.com/deyuhua/delve/pkg/locspec"
...
See $GOPATH/src/github.com/deyuhua/delve/Documentation/cli/locspec.md for the syntax of linespec.
...
A tracepoint is a breakpoint that does not stop the execution of the program, instead when the tracepoint is hit a notification is displayed. See $GOPATH/src/github.com/deyuhua/delve/Documentation/cli/locspec.md for the syntax of linespec.
...
See $GOPATH/src/github.com/deyuhua/delve/Documentation/cli/expr.md for a description of supported expressions.`},
...
See $GOPATH/src/github.com/deyuhua/delve/Documentation/cli/expr.md for a description of supported expressions. Only numerical variables and pointers can be changed.`},
...
If path ends with the .star extension it will be interpreted as a starlark script. See $GOPATH/src/github.com/deyuhua/delve/Documentation/cli/starlark.md for the syntax.
