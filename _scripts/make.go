...
const DelveMainPackagePath = "github.com/deyuhua/delve/cmd/dlv"
...
`,
	...
	integration 	tests github.com/deyuhua/delve/service/test
...
func testSetToPackages(testSet string) []string {
	...
	case "basic":
		return []string{"github.com/deyuhua/delve/pkg/proc", "github.com/deyuhua/delve/service/test", "github.com/deyuhua/delve/pkg/terminal"}

	case "integration":
		return []string{"github.com/deyuhua/delve/service/test"}
